...
char *docstring = "Return the tree-sitter language object for python.";
...
int emacs_module_init(struct emacs_runtime *ert) {
  ...
  emacs_value Qlang_func = env->intern(env, "tree-sitter-lang-python");
  args[0] = Qlang_func;
  args[1] = lang_func;
  ...
  // Provide the module
  emacs_value feature_name = env->intern(env, "tree-sitter-lang-python-module");
